...
public:
    ...
    void playFolderMP3TrackNumber(int trackNumber, boolean waitPlayTerminated);
...
void MP3Player::playFolderMP3TrackNumber(int trackNumber, boolean waitPlayTerminated)
{
